...
public class PhotoPicker {
  ...
  public final static String EXTRA_CAN_REMOVE = "EXTRA_CAN_REMOVE"; //是否可以编辑删除
  ...
  public static class PhotoPickerBuilder {
    ...
    public PhotoPickerBuilder setCanremove(boolean canremove) {
      mPickerOptionsBundle.putBoolean(EXTRA_CAN_REMOVE, canremove);
      return this;
    }
